package com.example.madpractical8_20012011193
...
class SplashActivity : AppCompatActivity(), Animation.AnimationListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        twinanimetion = AnimationUtils.loadAnimation(this,R.anim.twin_animations)
    ...
    override fun onAnimationEnd(p0: Animation?) {
        Intent(this,MainActivity::class.java).also {
            startActivity(it)
            overridePendingTransition(R.anim.scale_center_in,R.anim.scale_centre_out)
            finish()
        }
    }
